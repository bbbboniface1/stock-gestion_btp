...
function MobileHeader() {
  ...
  return (
    <header className="md:hidden flex items-center gap-3 px-4 py-3 border-b border-border bg-card sticky top-0 z-40 safe-area-pt">
    ...
    <SidebarProvider>
      <div className="min-h-screen flex w-full bg-background font-mono">
        ...
        <main className="flex-1 flex flex-col min-w-0 overflow-hidden">
          <MobileHeader />
          <div className="flex-1 overflow-y-auto p-4 md:p-6 lg:p-8 pb-[calc(6rem+env(safe-area-inset-bottom,0px))] md:pb-8">
            {children}
          </div>
        </main>
      </div>
